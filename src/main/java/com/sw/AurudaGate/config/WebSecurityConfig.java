        ...
        http
                ...
                .authorizeExchange(exchange -> exchange
                        ...
                        .pathMatchers("/aurudalogin/api/auruda/auth/logout","/aurudaarticle/api/auruda/article/new", "/aurudaarticle/api/auruda/article/{article_id}",
                                ...
                                "/aurudatrip/api/auruda/storage/**", "/aurudatrip/api/auruda/travel", "/aurudaarticle/api/auruda/article/image", "/aurudatrip/api/auruda/kako/places","/aurudalogin/api/auruda/image").authenticated()
